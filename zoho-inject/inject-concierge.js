...
<nav class="nav">
  ...
  <a class="nav-book" href="https://veltmtours.com/embed/butler-booking?popup=true" data-butler-button>Get Concierge</a>
</nav>
...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-actions" data-reveal style="--delay:0.2s">
      <a class="btn btn-indigo btn-lg" href="https://veltmtours.com/embed/butler-booking?popup=true" data-butler-button>Get Your Butler &mdash; From $25/Day</a>
    </div>
  </div>
</section>
...
<section class="diss-section">
  <div class="diss-inner" data-reveal>
    ...
    <div class="diss-box">
      <h3>The Ritz-Carlton &mdash; What $500/night buys:</h3>
