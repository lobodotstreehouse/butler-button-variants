    ...
    ld.textContent = JSON.stringify([
      ...
      },
      {
        ...
        "mainEntity":[
          ...
          {"@type":"Question","name":"How much does a trip plan cost?","acceptedAnswer":{"@type":"Answer","text":"$25 per country in your itinerary. No membership fee. Full refund if cancelled before your service begins. Up to 5 revisions within 180 days included."}},
...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-actions" data-reveal style="--delay:0.2s">
      ...
      <a class="btn btn-ghost-light btn-lg" href="#reach">Other ways to reach us</a>
  ...
  <div class="bb-ch__wrap">
    ...
    <div class="bb-ch__grid">
      <a class="bb-ch__card" href="https://wa.me/18555031555" target="_blank" rel="noopener">
        <div class="bb-ch__icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.5 14.4c-.3-.1-1.7-.8-2-.9-.3-.1-.4-.1-.6.1-.2.3-.7.9-.9 1.1-.2.2-.3.2-.6.1-.3-.1-1.3-.5-2.4-1.5-.9-.8-1.5-1.8-1.7-2.1-.2-.3 0-.5.1-.6.1-.1.3-.3.4-.5.1-.2.2-.3.3-.5.1-.2 0-.4 0-.5-.1-.1-.6-1.5-.9-2-.2-.5-.4-.5-.6-.5h-.5c-.2 0-.5.1-.7.3-.3.3-1 1-1 2.4 0 1.4 1 2.8 1.2 3 .1.2 2 3.1 4.9 4.3.7.3 1.2.5 1.6.6.7.2 1.3.2 1.8.1.5-.1 1.7-.7 1.9-1.4.2-.7.2-1.2.2-1.4-.1-.1-.3-.2-.6-.3zM12 2C6.5 2 2 6.5 2 12c0 1.8.5 3.5 1.3 4.9L2 22l5.3-1.3C8.6 21.5 10.3 22 12 22c5.5 0 10-4.5 10-10S17.5 2 12 2z"/></svg></div>
      ...
      <a class="bb-ch__card" href="https://veltmtoursofficial.zohobookings.in/#/veltmtourspvtltd" target="_blank" rel="noopener">
        <div class="bb-ch__icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17 10.5V7a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-3.5l4 4v-11l-4 4z"/></svg></div>
      ...
      <a class="bb-ch__card" href="mailto:contact@butlerbutton.co">
        <div class="bb-ch__icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm0 4l-8 5-8-5V6l8 5 8-5z"/></svg></div>
